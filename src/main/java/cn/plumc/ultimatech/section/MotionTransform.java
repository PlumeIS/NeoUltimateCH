...
public class MotionTransform {
    ...
    public static void updateEntityTransformation(Entity entity, TransformationEditor editor, double duration) {
    ...
    public static ListTag toFloatListTag(Vec3 vec) {
    ...
    public static ListTag toFloatListTag(Quaternionf q) {
        ListTag list = new ListTag();
    ...
    public static void safeSetData(EntityDataAccessor accessor, CompoundTag data) {
        try {
